...
int main(int argc, char *argv[])			{
	...
	printf("[TEST15]\n");
	printf("Tabulku inicializujeme (ztráta všech dat)\n");
	printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	test_ASInit(&TempTable);
	...
	printf("[TEST17]\n");
	printf("Pokusíme se vloit další poloky\n");
	printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	content=20;
	Key=30;
	test_ASInsert(&TempTable, Key, content);
	...
	printf("[TEST18]\n");
	printf("Pokusíme se vyhledat poloku s klíèem 40\n");
	printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	Key=40;
	test_ASSearch(&TempTable, Key, &ind);

	printf("[TEST19]\n");
	printf("Pokusíme se vyhledat poloku s klíèem 20\n");
	printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	Key=20;
	test_ASSearch(&TempTable, Key, &ind);
